        ...
        <div className="px-8 pb-8 relative">
            <div className="flex flex-col md:flex-row justify-between items-end -mt-12 mb-10 gap-4">
                <div className="flex items-end gap-6">
                    ...
                    <div className="mb-3">
                        <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Jean Dupont</h2>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="text" defaultValue="Jean Dupont" className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl py-3 pl-12 pr-4 text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-blue-500 transition-all" />
                        </div>
                    </div>
